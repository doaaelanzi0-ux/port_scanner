<!DOCTYPE html>
<!-- saved from url=(0043)http://localhost:8888/tree/DOAA%20EL%20ANZI -->
<html lang="en-gb"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    

    <title>DOAA EL ANZI/</title>
    ...
    <link rel="stylesheet" href="./python scanner_files/jquery-ui.min.css" type="text/css">
    <link rel="stylesheet" href="./python scanner_files/jquery.typeahead.min.css" type="text/css">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    
    
    <link rel="stylesheet" href="./python scanner_files/style.min.css" type="text/css">
    
    <link rel="stylesheet" href="./python scanner_files/custom.css" type="text/css">
    <script src="./python scanner_files/promise.min.js.download" type="text/javascript" charset="utf-8"></script>
    <script src="./python scanner_files/react.production.min.js.download" type="text/javascript"></script>
    <script src="./python scanner_files/react-dom.production.min.js.download" type="text/javascript"></script>
    <script src="./python scanner_files/index.js.download" type="text/javascript"></script>
    <script src="./python scanner_files/require.js.download" type="text/javascript" charset="utf-8"></script>
    <script>
      require.config({
          
          urlArgs: "v=20251031205220",
...
<script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="services/contents" src="./python scanner_files/contents.js.download"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="custom/custom-preload" src="./python scanner_files/custom-preload.js.download"></script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="custom/custom" src="./python scanner_files/custom.js.download"></script></head>

<body class="" data-jupyter-api-token="9bdf47c2ea1602bbd2bcd2fa0cf7fcb8e9268a95aefdb850" data-base-url="/" data-notebook-path="DOAA EL ANZI" data-terminals-available="True" data-server-root="C:\Users\doaa" dir="ltr">
...
<div id="header" role="navigation" aria-label="Top Menu" style="display: block;">
    ...
    <div class="alert alert-info" role="alert">
      <div style="display: flex">
        ...
        <div style="margin-left: auto;">
          <a href="http://localhost:8888/tree/DOAA%20EL%20ANZI" onclick="alert(&#39;This message will not be shown anymore.&#39;); return false;">
  ...
  <div id="ipython_notebook" class="nav navbar-brand"><a href="http://localhost:8888/tree?token=9bdf47c2ea1602bbd2bcd2fa0cf7fcb8e9268a95aefdb850" title="dashboard">
      <img src="./python scanner_files/logo.png" alt="Jupyter Notebook">
  </a></div>
...
<div id="site" style="display: block; height: 588.712px;">


  <div id="ipython-main-app" class="container">
    <div id="tab_content" class="tabbable" role="main">
      <ul id="tabs" class="nav nav-tabs">
        <li class="active"><a href="http://localhost:8888/tree/DOAA%20EL%20ANZI#notebooks" data-toggle="tab">Files</a></li>
        <li><a href="http://localhost:8888/tree/DOAA%20EL%20ANZI#running" data-toggle="tab">Running</a></li>
        <li><a href="http://localhost:8888/tree/DOAA%20EL%20ANZI#clusters" data-toggle="tab" class="clusters_tab_link">Clusters</a></li>
      </ul>
      <div class="tab-content">
        <div id="notebooks" class="tab-pane active">
              ...
              <div class="pull-right">
                ...
                <div id="new-buttons" class="btn-group">
                  ...
                  <ul id="new-menu" class="dropdown-menu" role="menu">
                    <li role="menuitem" class="dropdown-header" id="notebook-kernels">Notebook:</li><li id="kernel-python3"><a aria-label="python3" role="menuitem" href="http://localhost:8888/tree/DOAA%20EL%20ANZI#" title="Create a new notebook with Python 3 (ipykernel)">Python 3 (ipykernel)</a></li>
                    <li role="presentation" class="divider"></li>
                    <li role="menuitem" class="dropdown-header">Other:</li>
                    <li role="none" id="new-file">
                        <a role="menuitem" tabindex="-1" href="http://localhost:8888/tree/DOAA%20EL%20ANZI#">Text File</a>
                    </li>
                    <li role="none" id="new-folder">
                        <a role="menuitem" tabindex="-1" href="http://localhost:8888/tree/DOAA%20EL%20ANZI#">Folder</a>
                    </li>
                    
                    <li role="none" id="new-terminal">
                        <a role="menuitem" tabindex="-1" href="http://localhost:8888/tree/DOAA%20EL%20ANZI#">Terminal</a>
                    </li>
          ...
          <div id="notebook_list" class="list_container">
            <div id="notebook_list_header" class="row list_header">
              <div class="btn-group dropdown" id="tree-selector">
                ...
                <ul id="selector-menu" class="dropdown-menu" role="menu" aria-labelledby="tree-selector-btn">
                  <li role="none"><a id="select-folders" role="menuitem" tabindex="-1" href="http://localhost:8888/tree/DOAA%20EL%20ANZI#" title="Select All Folders"><i class="menu_icon folder_icon icon-fixed-width"></i>&nbsp;Folders</a></li>
                  <li role="none"><a id="select-notebooks" role="menuitem" tabindex="-1" href="http://localhost:8888/tree/DOAA%20EL%20ANZI#" title="Select All Notebooks"><i class="menu_icon notebook_icon icon-fixed-width"></i>&nbsp;All Notebooks</a></li>
                  <li role="none"><a id="select-running-notebooks" role="menuitem" tabindex="-1" href="http://localhost:8888/tree/DOAA%20EL%20ANZI#" title="Select Running Notebooks"><i class="menu_icon running_notebook_icon icon-fixed-width"></i>&nbsp;Running</a></li>
                  <li role="none"><a id="select-files" role="menuitem" tabindex="-1" href="http://localhost:8888/tree/DOAA%20EL%20ANZI#" title="Select All Files"><i class="menu_icon file_icon icon-fixed-width"></i>&nbsp;Files</a></li>
                </ul>
              </div>
              <div id="project_name">
                <ul class="breadcrumb"><li><a href="http://localhost:8888/tree" title="Link to root folder"><i class="fa fa-folder"></i></a></li><li><a href="http://localhost:8888/tree/DOAA%20EL%20ANZI">DOAA EL ANZI</a></li></ul>
              </div>
            ...
            </div><div class="list_item row"><div class="col-md-12"><input type="checkbox" title="Click here to rename, delete, etc." style="visibility: hidden;"><i class="item_icon folder_icon icon-fixed-width"></i><a class="item_link" href="http://localhost:8888/tree"><span class="item_name">..</span></a><div class="pull-right"><div class="item_buttons pull-left"><div class="running-indicator" style="visibility: hidden;">Running</div></div><div class="pull-right"><span class="item_modified pull-left" title="2025-10-31 20:54">seconds ago</span><span class="file_size pull-right">&nbsp;</span></div></div></div></div><div class="list_item row"><div class="col-md-12"><input type="checkbox" title="Click here to rename, delete, etc."><i class="item_icon notebook_icon icon-fixed-width"></i><a class="item_link" href="http://localhost:8888/notebooks/DOAA%20EL%20ANZI/TP_1.ipynb" target="_blank"><span class="item_name">TP_1.ipynb</span></a><div class="pull-right"><div class="item_buttons pull-left"><div class="running-indicator" style="visibility: hidden;">Running</div></div><div class="pull-right"><span class="item_modified pull-left" title="2025-10-29 20:28">2 days ago</span><span class="file_size pull-right">10.7 kB</span></div></div></div></div>
          </div>
        </div>
          ...
          <div class="panel-group" id="accordion">
            <div class="panel panel-default">
              <div class="panel-heading">
                <a data-toggle="collapse" data-target="#collapseOne" href="http://localhost:8888/tree/DOAA%20EL%20ANZI#">
                  Terminals
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <a data-toggle="collapse" data-target="#collapseTwo" href="http://localhost:8888/tree/DOAA%20EL%20ANZI#">
                  Notebooks
                <i class="fa fa-caret-down"></i></a>
              </div>
    ...
    <script src="./python scanner_files/main.min.js.download" type="text/javascript" charset="utf-8"></script>
...
<script type="text/javascript">
  ...
  sys_info = {"notebook_version": "6.5.4", "notebook_path": "C:\\Users\\doaa\\anaconda3\\Lib\\site-packages\\notebook", "commit_source": "", "commit_hash": "", "sys_version": "3.11.5 | packaged by Anaconda, Inc. | (main, Sep 11 2023, 13:26:23) [MSC v.1916 64 bit (AMD64)]", "sys_executable": "C:\\Users\\doaa\\anaconda3\\python.exe", "sys_platform": "win32", "platform": "Windows-10-10.0.26200-SP0", "os_name": "nt", "default_encoding": "utf-8"};
